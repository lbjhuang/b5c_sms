...
return  array(
    ...
    'APP_GROUP_LIST'        => 'Home,Guds',      // 项目分组设定,多个组之间用逗号分隔,例如'Home,Admin'
    'APP_GROUP_MODE'        =>  0,  // 分组模式 0 普通分组 1 独立分组
    'APP_GROUP_PATH'        =>  'Modules', // 分组目录 独立分组模式下面有效
    'ACTION_SUFFIX'         =>  '', // 操作方法后缀

    /* Cookie设置 */
    'COOKIE_EXPIRE'         => 14400,    // Coodie有效期
    ...
    'SESSION_OPTIONS'       => array('expire'=>14400), // session 配置数组 支持type name id path expire domain 等参数
