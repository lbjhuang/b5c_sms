...
class cls_image
{
     ...
     */
    function make_thumb($img, $thumb_width = 0, $thumb_height = 0, $path = '', $bgcolor='' ,$createfile='')
    {
    ...
    function add_watermark($filename, $target_file='', $watermark='', $watermark_place='', $watermark_alpha = 0.65)
    {
        ...
        switch ($watermark_place)
        {
            ...
            case '60002':
                $x = $source_info[0]/2 - $watermark_info[0]/2;
                $y = $source_info[1] - $watermark_info[1]*1.2;
                break;
            default:
                $x = $source_info[0]/2 - $watermark_info[0]/2;
     ...
     * @access  public
     */
    function get_img_resource($mime_type)
    {
        $res = '';
        switch ($mime_type)
        {
