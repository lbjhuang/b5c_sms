<?php
class QuestionTranDev implements QuestionStrategy
{
	function dealWithButton($data = [])
	{
		...
		$data['status'] = $questionService::$STATUS_DEVING;
		$data['opt_user_id'] = $questionService->getDefaultUser($questionService::$DEFAULT_DEV)['user_id'];
		$data['opt_user_name'] = $questionService->getDefaultUser($questionService::$DEFAULT_DEV)['name'];
