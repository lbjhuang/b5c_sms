<?php
class QuestionTranTst implements QuestionStrategy
{
	function dealWithButton($data = [])
	{
		...
		$data['opt_user_id'] = $questionService->getDefaultUser($questionService::$DEFAULT_TST)['user_id'];
		$data['opt_user_name'] = $questionService->getDefaultUser($questionService::$DEFAULT_TST)['name'];
