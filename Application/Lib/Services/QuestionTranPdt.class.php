<?php
class QuestionTranPdt implements QuestionStrategy
{
	function dealWithButton($data = [])
	{
		...
		$data['status'] = $questionService::$STATUS_DESIGNING;
		$data['opt_user_id'] = $questionService->getDefaultUser($questionService::$DEFAULT_PDT)['user_id'];
		$data['opt_user_name'] = $questionService->getDefaultUser($questionService::$DEFAULT_PDT)['name'];
