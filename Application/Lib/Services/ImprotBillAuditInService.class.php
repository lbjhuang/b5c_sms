 ...
 *
 * 出入库流程入库（重写）
 * Class ImprotBillAuditInService
 */

class ImprotBillAuditInService extends Service
{
    ...
    public function fieldMapping($mode)
    {
        $rules = [
            'default' => [
                ...
                'productTypeCd' => ['field_name' => '商品类型code', 'required' => true],//3  // 商品类型 正次品
    ...
    public function baseCode()
    {
        ...
        static::$baseCode ['storageMark'] = $model->table('tb_ms_cmn_cd')->where('CD LIKE "N00094%"  AND (ETC3 = "EXCEL出入库")')->getField('CD, CD_VAL');
        ...
        static::$baseCode ['productType'] = $model->table('tb_ms_cmn_cd')->where('CD LIKE "N00373%"')->getField('CD, CD_VAL');
    }
                ...
                if (!isset($this->existingError [$pos])) {
                    ...
                    switch ($fieldName) {
                        ...
                        case 'deadLine':
                            ...
                            break;
                        case 'productTypeCd':
                            isset(static::$baseCode ['productType'][$value]) or $this->errorinfo [][$pos] = L('不是有效的商品类型CODE');
                            break;
                    }
                }
            }
    ...
    public function packData()
    {
        ...
        foreach ($this->data as $index => $info) {
            ...
            $this->bill [$hash] = [
                ...
                'SP_TEAM_CD' => $purTeam,
                'vir_type' => $vir_type = $info ['virType']['value'],
            ...
            $broken_num = 0;
            $should_num = 0;
            if ($info['productTypeCd']['value'] == 'N003730003' ){
                $broken_num = $info ['number']['value'];
            }else{
