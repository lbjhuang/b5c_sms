<?php
class QuestionUndefined implements QuestionStrategy
{
	function dealWithButton($data = [])
	{
		...
		$data['status'] = $questionService::$STATUS_UNDEFINED;
		...
		$wx_user = $question_log_model->getDealUser($data['info']['question_user_id']);
