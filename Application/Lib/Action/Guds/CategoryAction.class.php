...
class CategoryAction extends BaseAction{
    ...
    public function create(){
        $params['levelFirst'] = I('levelFirst');
        $params['levelSecond'] = I('levelSecond');
        $params['catLevel'] = I('catLevel');
        $params['catName'] = I('catName');
        $params['catCnName'] = I('cnName');
        $params['aliasName'] = I('aliasName');
        //$params['catAlp'] = I('catAlp');
        
        if (empty($params['catName']) || empty($params['catCnName'])){
    ...
    public function update()
    {
        ...
        $update['DISABLE_YN'] = !empty($isVisible) ? $isVisible : 'Y';
