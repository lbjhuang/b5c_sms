const warehouseRecommendedDeliveryCountry = Vue.component("warehouseRecommendedDeliveryCountry", {
    template: `
<div class="delivery-country">
  <div class="edit">
    ...
    created() {
        this.$bus.$on("get-delivery-country-by-add", (values) => {
    ...
    beforeDestroy() {
        this.$bus.$off("get-delivery-country-by-add")
    },
    methods: {
        onAdd() {
        ...
        onSave() {
            let allSelectedDeliveryCountry = _.cloneDeep(this.allSelectedDeliveryCountry);
            this.$bus.$emit("add-all-delivery-country", allSelectedDeliveryCountry);
            this.$emit('closed-delivery-country', false)
