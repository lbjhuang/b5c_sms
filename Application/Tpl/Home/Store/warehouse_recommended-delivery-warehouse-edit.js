const warehouseRecommendedDeliveryWarehouseEdit = Vue.component("warehouseRecommendedDeliveryWarehouseEdit", {
    template: `
<div class="delivery-warehouse">
  <div class="edit">
    ...
    created() {
        this.$bus.$on("get-delivery-warehouse-by-edit", (values) => {
    ...
    beforeDestroy() {
        this.$bus.$off("get-delivery-warehouse-by-edit")
    },
    methods: {
        onPageChange() {
        ...
        onSave() {
            ...
            this.$bus.$emit("edit-all-delivery-warehouse", allSelectedDeliveryWareHouse);
            this.$emit('closed-delivery-warehouse-by-edit', false)
