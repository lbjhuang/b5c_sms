const warehouseRecommendedGoodsSkuPrefix = Vue.component("warehouseRecommendedGoodsSkuPrefix", {
    template: `
<div class="goodsSkuPrefix">
  <div class="edit">
    ...
    created() {
        ...
        this.$bus.$on("get-goods-sku-prefix-by-add", (values) => {
    ...
    beforeDestroy() {
        this.$bus.$off("get-goods-sku-prefix-by-add")
    },
    methods: {
        onPageChange() {
        ...
        onSave() {
            ...
            if (this.skuPrefix) {
                ...
                this.$bus.$emit("add-all-selected-sku-prefix", skuPrefixArray);
                this.$emit('closed-goods-sku-prefix', false)

            } else {
                this.$bus.$emit("add-all-selected-sku-prefix", this.skuPrefix);
                this.$emit('closed-goods-sku-prefix', false)
            }
