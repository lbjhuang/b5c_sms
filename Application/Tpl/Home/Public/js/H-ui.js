...
/*返回顶部*/
var $backToTopEle=$('<a href="javascript:void(0)" class="Hui-iconfont toTop" title="返回顶部" alt="返回顶部" style="width:40px;height:40px;display:none;position:fixed;right:50px;bottom:30px;z-index:999999"><img src="/Application/Tpl/Home/Public/images/top.png" style="width:42px;height:42px;margin-left:-1px;"></a>').appendTo($("body")).click(function(){
