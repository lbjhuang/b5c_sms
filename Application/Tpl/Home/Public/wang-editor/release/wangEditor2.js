...
var config = {
    ...
    // 默认菜单配置
    menus: ['head', 'bold', 'fontSize', 'lineFontSize', 'lineHeight', 'fontName', 'italic', 'underline', 'strikeThrough', 'foreColor', 'backColor', 'link', 'list', 'justify', 'quote', 'emoticon', 'image', 'table', 'video', 'code', 'undo', 'redo'],

    fontNames: ['宋体', '微软雅黑', 'Arial', 'Tahoma', 'Verdana','Gilroy-Bold','Gilroy-Medium','Gilroy-Regular'],

    colors: ['#000000', '#eeece0', '#1c487f', '#4d80bf', '#c24f4a', '#8baa4a', '#7b5ba1', '#46acc8', '#f9963b', '#ffffff','#999999'],
...
function LineFontSize(editor) {
    ...
    this.droplist = new DropList(this, {
        ...
        list: [{
            ...
            $elem: $('<span style="font-size:60px;">60px</span>'),
            value: '60px'
        }],
        onClick: function onClick(value) {
            // 注意 this 是指向当前的 FontSize 对象
...
function LineHeight(editor) {
    ...
    this.droplist = new DropList(this, {
        ...
        type: 'list',
        list: [{
            $elem: $('<span style="line-height: 12px ;">12px</span>'),
            value: '12px'
        },{
            $elem: $('<span style="line-height: 14px ;">14px</span>'),
            value: '14px'
        }, {
            $elem: $('<span style="line-height: 16px;">16px</span>'),
            value: '16px'
        }, {
            $elem: $('<span style="line-height: 18px ;">18px</span>'),
            value: '18px'
        }, {
            $elem: $('<span style="line-height: 20px;">20px</span>'),
            value: '20px'
        }, {
            $elem: $('<span style="line-height: 24px ;">24px</span>'),
            value: '24px'
        }, { $elem: $('<span style="line-height: 28px;">28px</span>'),
            value: '28px'
        }, { $elem: $('<span style="line-height: 32px;">32px</span>'),
            value: '32px'
        }, { $elem: $('<span style="line-height: 38px;">38px</span>'),
            value: '38px'
        }, { $elem: $('<span style="line-height: 60px;">60px</span>'),
            value: '60px'
        }, { $elem: $('<span style="line-height: 66px;">66px</span>'),
            value: '66px'
        }, { $elem: $('<span style="line-height: 80px;">80px</span>'),
            value: '80px'
        }],
        onClick: function onClick(value) {
            _this._command(value);
