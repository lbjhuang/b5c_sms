...
//    'N000551000'               => '交易取消',
    ...
    "scm_ceo_email_cc"                      => "due@gshopper.com",
    "finance_email"                         => "feisong@gshopper.com",

    //rabbit mq配置
    'rabbit_mq_config' => [
        'host' => '172.16.11.18:5672',
        'port' => '5672',
        'login' => 'gsapp',
    ...
    // 供应商客户管理法务跳转地址
    'redirect_audit_addr' => 'erp.gshopper.prod.com',
    // 是否开启抄送
    'is_start_cc' => false,
    // 是否开启密送
    'is_start_bcc' => false,
    //redis 配置
    'REDIS_SERVER' => [
        'tcp://172.16.111.18:6001',
        'tcp://172.16.111.18:6002',
        'tcp://172.16.111.18:6003',
    ],
    'redis_batch_generate_url' => 'http://s.prod.com/check/reloadDeliveryData',
    'openApiUrl' => 'http://openapi.prod.co.kr',
    ...
    'insight_db_config' => [
        ...
        'db_user'       => 'erp',
        'db_pwd'        => 'erp@123',
        'db_dsn'        => 'pgsql:host=172.16.5.12;dbname=b5mrep',
    ],
    'mt_db_config' => [
        'db_type' => 'pdo',
        'db_user' => 'erp',
    ...
    'b5cErpDBName' => 'b5c_prod',
    'b5cPmsDbName' => 'gshopper_pms_prod',
