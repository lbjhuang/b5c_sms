...
define('API_CRAWLER','http://172.16.111.76:8080');//Murphy Peng提供接口 速卖通运输方式
...
define('ERP_CRON_TASK_URL','http://172.16.111.69/');
...
define('INSIGHT','http://insight.gshopper.stage.com');
...
define('OPEN_HOST','http://open.gshopper.stage.com');
...
define('ATTACHMENT_DIR_DOC','/opt/b5c-disk/doc/');
...
//IT API
define('IT_API', 'http://it.gshopper.com');


//SHOPNC API
define('ERP_SECRET', '93ddf0b6131caa678c1ecff35f4de6b1');
define('SHOPNC_URL', 'http://shopnc.stage.gshopper.com');


//  ERP同步
define('SYNC_ERP', 'erpexternal.gshopper.stage.com');

//Java报文日志
define('MESSAGE_LOG_URL','http://172.16.111.59:8080');
